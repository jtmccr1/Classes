...
ggplot(data=gt1,mapping=aes(x=carapace.length,color=elisa)) + geom_point(aes(y=serostatus),position='jitter')+ geom_line(aes(y=fitted2,color='Fitted Lambda'))+geom_line(aes(y=fitted2_big,color="Big Lambda"))                                                                                                                                                       
